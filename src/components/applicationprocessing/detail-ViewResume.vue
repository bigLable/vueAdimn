  ...
  <div>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="职位详情" name="first">
        <el-select v-model="value"  @change="JobRequire(value)" placeholder="请选择">
          <el-option
        ...
        <div class="userInfo">
          ...
          <el-row>
            <el-col :span="5">
               <viewer :images="[userinfo.bustPhotoUrl]">
	         <img v-for="src in [userinfo.bustPhotoUrl]" :src="src" :key="src" width="200">
	       </viewer>
        ...
        <el-row>
          ...
          <el-col :span="2">{{jobRequire.isWorkTime}}|</el-col>
          <el-col :span="8">{{jobRequire.address}}|</el-col>
          <el-col :span="3">{{jobRequire.market}}</el-col>
          <el-col :span="3" style="color:red">{{jobRequire.baseSalaryStart}}-{{jobRequire.baseSalaryEnd}}</el-col>
